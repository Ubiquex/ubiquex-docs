...
<Tabs>
  <Tab title="Go">
    ...
    func main() {
    	ubx.Main(ubx.Stack("example", func() {
    		...
    		ubx.Resource(securesourcemanager.SecuresourcemanagerRepository, "example", securesourcemanager.SecuresourcemanagerRepositoryConfig{
    			Name: "example",
    		})
    	}))
    }
  ...
  <Tab title="TypeScript">
    ...
    export default stack("example", () => {
      ...
      resource(SecuresourcemanagerRepository, "example", {
        name: "example",
      });
    });
    ```
  ...
  <Tab title="Python">
    ...
    def describe():
        ...
        ubx.resource(SecuresourcemanagerRepository, "example", SecuresourcemanagerRepositoryConfig(
            name="example",
        ))
  ...
  <Tab title="Markdown">
    ```
    Create google_securesourcemanager_repository called "example",
    with .
    ```
  </Tab>
</Tabs>
