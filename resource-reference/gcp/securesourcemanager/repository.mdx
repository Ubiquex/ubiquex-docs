...
<Tabs>
  <Tab title="Go">
    ...
    func main() {
    	ubx.Main(ubx.Stack("example", func() {
    		...
    		ubx.Resource(securesourcemanager.Repository, "example", securesourcemanager.RepositoryConfig{
    			Name: "example",
    		})
    	}))
    }
  ...
  <Tab title="TypeScript">
    ...
    import { Repository } from "@ubx/sdk-google/google/securesourcemanager/repository";
  ...
  <Tab title="Python">
    ...
    from ubx.google.securesourcemanager.repository import Repository, RepositoryConfig
