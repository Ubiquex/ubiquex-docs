---
title: "google_securesourcemanager_repository"
description: "`google_securesourcemanager_repository` is a Git repository hosted within a Secure Source Manager instance, Google Cloud's own fully managed..."
---

`google_securesourcemanager_repository` is a Git repository hosted within a Secure Source Manager instance, Google Cloud's own fully managed, private source code hosting service.
...
<Tabs>
  <Tab title="Go">
    ...
    func main() {
    	ubx.Main(ubx.Stack("payments", func() {
    		...
    		ubx.Resource(securesourcemanager.SecuresourcemanagerRepository, "ci-runner", securesourcemanager.SecuresourcemanagerRepositoryConfig{
    			Name: "ci-runner",
    		})
    	}))
    }
  ...
  <Tab title="TypeScript">
    ...
    import { SecuresourcemanagerRepository } from "./local-sdk/google_securesourcemanager/sdk/typescript/google_securesourcemanager/securesourcemanager/securesourcemanager_repository.ts";

    export default stack("payments", () => {
      intent({ summary: "payments own repository" });

      resource(SecuresourcemanagerRepository, "ci-runner", {
        name: "ci-runner",
      });
    });
    ```
  ...
  <Tab title="Python">
    ...
    from ubx.google_securesourcemanager.securesourcemanager import SecuresourcemanagerRepository, SecuresourcemanagerRepositoryConfig

    def describe():
        ubx.intent("payments own repository")

        ubx.resource(SecuresourcemanagerRepository, "ci-runner", SecuresourcemanagerRepositoryConfig(
            name="ci-runner",
        ))
  ...
  <Tab title="Markdown">
    ```
    Create google_securesourcemanager_repository called "ci-runner",
    with .
    ```
  </Tab>
</Tabs>
...
<ResponseField name="description" type="string">
  Optional. Description of the repository, which cannot exceed 500 characters. Optional; if omitted, computed by Google Cloud.
</ResponseField>
...
<ResponseField name="initial_config" type="object">
  Repository initialization configuration. Optional; if omitted, computed by Google Cloud.
  <Expandable title="properties">
    <ResponseField name="default_branch" type="string">
      Default branch name of the repository. Optional.
    </ResponseField>
...
<ResponseField name="service_account" type="string">
  Optional. Repository level service account (BYOSA). Optional; if omitted, computed by Google Cloud.
</ResponseField>
...
<ResponseField name="uris" type="object">
  URIs for the repository. Optional; if omitted, computed by Google Cloud.
  <Expandable title="properties">
    <ResponseField name="api" type="string">
      Output only. API is the URI for API access. Computed by Google Cloud after `ship`.
    </ResponseField>
    <ResponseField name="git_https" type="string">
      Output only. git_https is the git HTTPS URI for git operations. Computed by Google Cloud after `ship`.
    </ResponseField>
    <ResponseField name="html" type="string">
      Output only. HTML is the URI for user to view the repository in a browser. Computed by Google Cloud after `ship`.
    </ResponseField>
  </Expandable>
</ResponseField>
