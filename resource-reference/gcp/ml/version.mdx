...
<Tabs>
  <Tab title="Go">
    ...
    func main() {
    	ubx.Main(ubx.Stack("example", func() {
    		...
    		ubx.Resource(ml.MlVersion, "example", ml.MlVersionConfig{
    			Name: "example",
    		})
    	}))
    }
  ...
  <Tab title="Python">
    ...
    def describe():
        ...
        ubx.resource(MlVersion, "example", MlVersionConfig(
            name="example",
        ))
  ...
  <Tab title="Markdown">
    ```
    Create google_ml_version called "example", with .
    ```
  </Tab>
</Tabs>
