...
<Tabs>
  <Tab title="Go">
    ...
    func main() {
    	ubx.Main(ubx.Stack("example", func() {
    		...
    		ubx.Resource(ml.Version, "example", ml.VersionConfig{
    			Name: "example",
    		})
    	}))
    }
  ...
  <Tab title="TypeScript">
    ...
    import { Version } from "@ubx/sdk-google/google/ml/version";
  ...
  <Tab title="Python">
    ...
    from ubx.google.ml.version import Version, VersionConfig
