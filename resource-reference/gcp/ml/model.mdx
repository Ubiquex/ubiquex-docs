...
<Tabs>
  <Tab title="Go">
    ...
    func main() {
    	ubx.Main(ubx.Stack("example", func() {
    		...
    		ubx.Resource(ml.MlModel, "example", ml.MlModelConfig{
    			Name: "example",
    		})
    	}))
    }
  ...
  <Tab title="Python">
    ...
    def describe():
        ...
        ubx.resource(MlModel, "example", MlModelConfig(
            name="example",
        ))
  ...
  <Tab title="Markdown">
    ```
    Create google_ml_model called "example", with .
    ```
  </Tab>
</Tabs>
