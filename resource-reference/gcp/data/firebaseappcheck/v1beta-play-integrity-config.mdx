---
title: "google_firebaseappcheck_v1beta_play_integrity_config"
description: "`data_firebaseappcheck_v1beta_play_integrity_config` looks up a real Firebase App Check Play Integrity configuration, via the v1beta API."
---
...
<Tabs>
  <Tab title="Go">
    ...
    func main() {
    	ubx.Main(ubx.Stack("example", func() {
    		ubx.Intent(ubx.IntentInfo{Summary: "look up google_firebaseappcheck_v1beta_play_integrity_config"})

    		ubx.Data(firebaseappcheck.V1betaPlayIntegrityConfig, "example", firebaseappcheck.V1betaPlayIntegrityConfigConfig{
    			Name: "example",
    		})
    	}))
    }
  ...
  <Tab title="TypeScript">
    ...
    import { V1betaPlayIntegrityConfig } from "./local-sdk/google/sdk/typescript/google/data/firebaseappcheck/v1beta_play_integrity_config.ts";

    export default stack("example", () => {
      intent({
        summary: "look up google_firebaseappcheck_v1beta_play_integrity_config",
      });

      data(V1betaPlayIntegrityConfig, "example", {
        name: "example",
      });
    });
    ```
  ...
  <Tab title="Python">
    ...
    from ubx.google.data.firebaseappcheck import V1betaPlayIntegrityConfig, V1betaPlayIntegrityConfigConfig

    def describe():
        ubx.intent("look up google_firebaseappcheck_v1beta_play_integrity_config")

        ubx.data(V1betaPlayIntegrityConfig, "example", V1betaPlayIntegrityConfigConfig(
            name="example",
        ))
