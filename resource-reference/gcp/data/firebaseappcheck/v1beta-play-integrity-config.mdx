...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    import { V1betaPlayIntegrityConfig } from "@ubx/sdk-google/google/data/firebaseappcheck/v1beta_play_integrity_config";
