...
description: "`aws_resource_groups_tag_sync_task` is a real, live lookup against AWS, generated from aws's own real schema -- read-only, never created or destroyed."
---
