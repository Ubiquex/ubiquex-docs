...
<Tabs>
  ...
  <Tab title="Python">
    ...
    from ubx.aws.data.ce.reservation_purchase_recommendation import ReservationPurchaseRecommendation_Filter, ReservationPurchaseRecommendation_Filter_And, ReservationPurchaseRecommendation_Recommendations_ServiceSpecification, ReservationPurchaseRecommendation_Recommendations_ServiceSpecification_Ec2Specification
    ...
    def describe():
        ...
        ubx.data(ReservationPurchaseRecommendation, "example", ReservationPurchaseRecommendationConfig(
            ...
            filter=ReservationPurchaseRecommendation_Filter(and_=[ReservationPurchaseRecommendation_Filter_And()]),
            lookback_period_in_days="example",
            page_size=1,
            payment_option="example",
            service_specification=ReservationPurchaseRecommendation_Recommendations_ServiceSpecification(ec2_specification=ReservationPurchaseRecommendation_Recommendations_ServiceSpecification_Ec2Specification(offering_class="example")),
        ))
