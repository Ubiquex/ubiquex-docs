---
title: "aws_ce_savings_plans_utilization_details"
description: "`aws_ce_savings_plans_utilization_details` reads real, per-Savings-Plan utilization details."
---
...
<Tabs>
  <Tab title="Go">
    ...
    func main() {
    	ubx.Main(ubx.Stack("example", func() {
    		ubx.Intent(ubx.IntentInfo{Summary: "look up aws_ce_savings_plans_utilization_details"})

    		ubx.Data(ce.SavingsPlansUtilizationDetails, "example", ce.SavingsPlansUtilizationDetailsConfig{
  ...
  <Tab title="TypeScript">
    ...
    import { SavingsPlansUtilizationDetails } from "@ubx/sdk-aws/aws/data/ce/savings_plans_utilization_details";

    export default stack("example", () => {
      intent({ summary: "look up aws_ce_savings_plans_utilization_details" });

      data(SavingsPlansUtilizationDetails, "example", {
  ...
  <Tab title="Python">
    ...
    from ubx.aws.data.ce import SavingsPlansUtilizationDetails, SavingsPlansUtilizationDetailsConfig
    from ubx.aws.data.ce.savings_plans_utilization_details import SavingsPlansUtilizationDetails_TimePeriod, SavingsPlansUtilizationDetails_Filter, SavingsPlansUtilizationDetails_Filter_And, SavingsPlansUtilizationDetails_SortBy

    def describe():
        ubx.intent("look up aws_ce_savings_plans_utilization_details")

        ubx.data(SavingsPlansUtilizationDetails, "example", SavingsPlansUtilizationDetailsConfig(
            time_period=SavingsPlansUtilizationDetails_TimePeriod(end="example", start="example"),
            data_type=["example"],
            filter=SavingsPlansUtilizationDetails_Filter(and_=[SavingsPlansUtilizationDetails_Filter_And()]),
            max_results=1,
            sort_by=SavingsPlansUtilizationDetails_SortBy(key="example"),
        ))
...
<ResponseField name="data_type" type="list(string)">
...
<ResponseField name="savings_plans_utilization_details" type="list(object)">
  The real, detailed information about the savings plans utilization. **(AI-inferred)** Returned by the lookup.
</ResponseField>

<ResponseField name="total" type="object">
  &lt;p&gt;The aggregated utilization metrics for your Savings Plans usage.&lt;/p&gt; Returned by the lookup.
  <Expandable title="properties">
    <ResponseField name="amortized_commitment" type="object">
      &lt;p&gt;The amortized amount of Savings Plans purchased in a specific account during a specific time interval.&lt;/p&gt; Optional lookup argument.
      <Expandable title="properties">
        <ResponseField name="amortized_recurring_commitment" type="string">
          Optional lookup argument.
        </ResponseField>
        <ResponseField name="amortized_upfront_commitment" type="string">
          Optional lookup argument.
        </ResponseField>
        <ResponseField name="total_amortized_commitment" type="string">
          Optional lookup argument.
        </ResponseField>
      </Expandable>
    </ResponseField>
    <ResponseField name="savings" type="object">
      &lt;p&gt;The amount of savings that you're accumulating, against the public On-Demand rate of the usage accrued in an account.&lt;/p&gt; Optional lookup argument.
      <Expandable title="properties">
        <ResponseField name="net_savings" type="string">
          Optional lookup argument.
        </ResponseField>
        <ResponseField name="on_demand_cost_equivalent" type="string">
          Optional lookup argument.
        </ResponseField>
      </Expandable>
    </ResponseField>
    <ResponseField name="utilization" type="object" required>
      &lt;p&gt;The measurement of how well you're using your existing Savings Plans.&lt;/p&gt; Required lookup argument.
      <Expandable title="properties">
        <ResponseField name="total_commitment" type="string">
          Optional lookup argument.
        </ResponseField>
        <ResponseField name="unused_commitment" type="string">
          Optional lookup argument.
        </ResponseField>
        <ResponseField name="used_commitment" type="string">
          Optional lookup argument.
        </ResponseField>
