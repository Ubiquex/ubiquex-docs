---
title: "aws_ce_savings_plans_purchase_recommendation"
description: "`aws_ce_savings_plans_purchase_recommendation` reads a real, system-generated Cost Explorer Savings Plans purchase recommendation."
---
...
<Tabs>
  <Tab title="Go">
    ...
    func main() {
    	ubx.Main(ubx.Stack("example", func() {
    		ubx.Intent(ubx.IntentInfo{Summary: "look up aws_ce_savings_plans_purchase_recommendation"})

    		ubx.Data(ce.SavingsPlansPurchaseRecommendation, "example", ce.SavingsPlansPurchaseRecommendationConfig{
    			LookbackPeriodInDays: "example",
    			PaymentOption:        "example",
    			SavingsPlansType:     "example",
    			TermInYears:          "example",
  ...
  <Tab title="TypeScript">
    ...
    import { SavingsPlansPurchaseRecommendation } from "./local-sdk/aws/sdk/typescript/aws/data/ce/savings_plans_purchase_recommendation.ts";

    export default stack("example", () => {
      intent({ summary: "look up aws_ce_savings_plans_purchase_recommendation" });

      data(SavingsPlansPurchaseRecommendation, "example", {
        lookbackPeriodInDays: "example",
        paymentOption: "example",
        savingsPlansType: "example",
        termInYears: "example",
  ...
  <Tab title="Python">
    ...
    from ubx.aws.data.ce import SavingsPlansPurchaseRecommendation, SavingsPlansPurchaseRecommendationConfig

    def describe():
        ubx.intent("look up aws_ce_savings_plans_purchase_recommendation")

        ubx.data(SavingsPlansPurchaseRecommendation, "example", SavingsPlansPurchaseRecommendationConfig(
            lookback_period_in_days="example",
            payment_option="example",
            savings_plans_type="example",
            term_in_years="example",
...
<ResponseField name="lookback_period_in_days" type="string" required>
  The real number of days results are computed over, looking back from now. **(AI-inferred)** Required lookup argument.
</ResponseField>
...
<ResponseField name="payment_option" type="string" required>
  The real payment option this lookup is scoped to. **(AI-inferred)** Required lookup argument.
</ResponseField>

<ResponseField name="savings_plans_type" type="string" required>
  The real, discriminating type of the savings plans this lookup is scoped to. **(AI-inferred)** Required lookup argument.
</ResponseField>

<ResponseField name="term_in_years" type="string" required>
  The real term of this object, in years. **(AI-inferred)** Required lookup argument.
</ResponseField>

## Result properties

<ResponseField name="metadata" type="object">
  &lt;p&gt;Metadata about your Savings Plans Purchase Recommendations.&lt;/p&gt; Returned by the lookup.
  <Expandable title="properties">
...
<ResponseField name="savings_plans_purchase_recommendation" type="object">
  &lt;p&gt;Contains your request parameters, Savings Plan Recommendations Summary, and Details.&lt;/p&gt; Returned by the lookup.
  <Expandable title="properties">
    <ResponseField name="account_scope" type="string">
      Optional lookup argument.
    </ResponseField>
    ...
    <ResponseField name="savings_plans_purchase_recommendation_details" type="list(object)">
      Optional lookup argument.
    </ResponseField>
    <ResponseField name="savings_plans_purchase_recommendation_summary" type="object">
      &lt;p&gt;Summary metrics for your Savings Plans Purchase Recommendations.&lt;/p&gt; Optional lookup argument.
      <Expandable title="properties">
        ...
        <ResponseField name="daily_commitment_to_purchase" type="string">
          Optional lookup argument.
        </ResponseField>
        ...
        <ResponseField name="estimated_total_cost" type="string">
          Optional lookup argument.
        </ResponseField>
