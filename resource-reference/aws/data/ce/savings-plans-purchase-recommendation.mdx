...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    import { SavingsPlansPurchaseRecommendation } from "@ubx/sdk-aws/aws/data/ce/savings_plans_purchase_recommendation";
  ...
  <Tab title="Python">
    ...
    from ubx.aws.data.ce.savings_plans_purchase_recommendation import SavingsPlansPurchaseRecommendation_Filter, SavingsPlansPurchaseRecommendation_Filter_And
    ...
    def describe():
        ...
        ubx.data(SavingsPlansPurchaseRecommendation, "example", SavingsPlansPurchaseRecommendationConfig(
            ...
            filter=SavingsPlansPurchaseRecommendation_Filter(and_=[SavingsPlansPurchaseRecommendation_Filter_And()]),
            page_size=1,
        ))
