---
title: "aws_ce_savings_plans_utilization"
description: "`aws_ce_savings_plans_utilization` reads real, computed Savings Plans utilization over time."
---
...
<Tabs>
  <Tab title="Go">
    ...
    func main() {
    	ubx.Main(ubx.Stack("example", func() {
    		ubx.Intent(ubx.IntentInfo{Summary: "look up aws_ce_savings_plans_utilization"})

    		ubx.Data(ce.SavingsPlansUtilization, "example", ce.SavingsPlansUtilizationConfig{
  ...
  <Tab title="TypeScript">
    ...
    import { SavingsPlansUtilization } from "@ubx/sdk-aws/aws/data/ce/savings_plans_utilization";

    export default stack("example", () => {
      intent({ summary: "look up aws_ce_savings_plans_utilization" });

      data(SavingsPlansUtilization, "example", {
  ...
  <Tab title="Python">
    ...
    from ubx.aws.data.ce import SavingsPlansUtilization, SavingsPlansUtilizationConfig
    from ubx.aws.data.ce.savings_plans_utilization import SavingsPlansUtilization_SavingsPlansUtilizationsByTime_TimePeriod, SavingsPlansUtilization_Filter, SavingsPlansUtilization_Filter_And, SavingsPlansUtilization_SortBy

    def describe():
        ubx.intent("look up aws_ce_savings_plans_utilization")

        ubx.data(SavingsPlansUtilization, "example", SavingsPlansUtilizationConfig(
            time_period=SavingsPlansUtilization_SavingsPlansUtilizationsByTime_TimePeriod(end="example", start="example"),
            filter=SavingsPlansUtilization_Filter(and_=[SavingsPlansUtilization_Filter_And()]),
            granularity="example",
            sort_by=SavingsPlansUtilization_SortBy(key="example"),
        ))
...
<ResponseField name="savings_plans_utilizations_by_time" type="list(object)">
  The real timestamp of the savings plans utilizations by. **(AI-inferred)** Returned by the lookup.
</ResponseField>
