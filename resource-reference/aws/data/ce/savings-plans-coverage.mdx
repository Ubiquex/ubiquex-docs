---
title: "aws_ce_savings_plans_coverage"
description: "`aws_ce_savings_plans_coverage` reads real, computed Savings Plans coverage of an account's own usage over time."
---
...
<Tabs>
  <Tab title="Go">
    ...
    func main() {
    	ubx.Main(ubx.Stack("example", func() {
    		ubx.Intent(ubx.IntentInfo{Summary: "look up aws_ce_savings_plans_coverage"})

    		ubx.Data(ce.SavingsPlansCoverage, "example", ce.SavingsPlansCoverageConfig{
  ...
  <Tab title="TypeScript">
    ...
    import { SavingsPlansCoverage } from "@ubx/sdk-aws/aws/data/ce/savings_plans_coverage";

    export default stack("example", () => {
      intent({ summary: "look up aws_ce_savings_plans_coverage" });

      data(SavingsPlansCoverage, "example", {
  ...
  <Tab title="Python">
    ...
    from ubx.aws.data.ce import SavingsPlansCoverage, SavingsPlansCoverageConfig
    from ubx.aws.data.ce.savings_plans_coverage import SavingsPlansCoverage_SavingsPlansCoverages_TimePeriod, SavingsPlansCoverage_Filter, SavingsPlansCoverage_Filter_And, SavingsPlansCoverage_GroupBy, SavingsPlansCoverage_SortBy

    def describe():
        ubx.intent("look up aws_ce_savings_plans_coverage")

        ubx.data(SavingsPlansCoverage, "example", SavingsPlansCoverageConfig(
            time_period=SavingsPlansCoverage_SavingsPlansCoverages_TimePeriod(end="example", start="example"),
            filter=SavingsPlansCoverage_Filter(and_=[SavingsPlansCoverage_Filter_And()]),
            granularity="example",
            group_by=[SavingsPlansCoverage_GroupBy(key="example")],
            max_results=1,
            metrics=["example"],
            sort_by=SavingsPlansCoverage_SortBy(key="example"),
        ))
...
<ResponseField name="savings_plans_coverages" type="list(object)">
  The real Savings Plans coverage results included in this result. **(AI-inferred)** Returned by the lookup.
</ResponseField>
