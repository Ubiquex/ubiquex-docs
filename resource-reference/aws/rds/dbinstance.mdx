...
<Tabs>
  ...
  <Tab title="Python">
    ...
    from ubx.aws.rds.dbinstance import Dbinstance_AdditionalStorageVolumes, Dbinstance_AssociatedRoles

    def describe():
        ubx.intent("example own dbinstance")

        ubx.resource(Dbinstance, "example", DbinstanceConfig(
            additional_storage_volumes=[Dbinstance_AdditionalStorageVolumes(allocated_storage="example")],
            allocated_storage="example",
            allow_major_version_upgrade=True,
            apply_immediately=True,
            associated_roles=[Dbinstance_AssociatedRoles(feature_name="example-feature-name")],
